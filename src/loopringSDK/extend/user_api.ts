...
// +----------------------------------------------------------------------------
import { BaseAPI } from "@loopring-web/loopring-sdk";
...
export class UserExtendAPI extends BaseAPI {
      public async getUpdateAccountMsg(request: any, chainId: number) {
            const result =
                  await sign_tools.getSignUpdateAccountWithoutDataStructure(
                        request,
                        chainId
                  );
            return result;
      ...
      public async getTransferNftMsg(request: any, chainId: number) {
            const result = await sign_tools.getNFTTransferWithoutDataStructure(
                  request,
                  chainId
            );
            return result;
